 ...
 * @subpackage Moxcar_Hosting_Utility_Plugin/public
 */
 ...
 */
class Moxcar_Hosting_Utility_Plugin_Public {
	...
	public function enqueue_styles() {
		 ...
		 * defined in Moxcar_Hosting_Utility_Plugin_Loader as all of the hooks are defined
		 * in that particular class.
		 *
		 * The Moxcar_Hosting_Utility_Plugin_Loader will then create the relationship
		 * between the defined hooks and the functions defined in this
		 * class.
		 */

		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/moxcar-hosting-utility-plugin-public.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/moxcar-hosting-utility-plugin-public.js', array( 'jquery' ), $this->version, false );
